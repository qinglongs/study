 ...
 * **这里也是作用域链导致，形参func内部v取值是v='outer'**
 */
 ...
 *  **这里形参func内部的y，向上查找变量y，但是找不到，所以报错**
 */
...
/**
 * 如果将var e = 3 的var去掉，函数foo的内部变量e就指向第一个参数e，与匿名函数内部的
 * e是一致的，最后输出的就是2，而外层的全局变量x依然不受影响
 * **作用域链的影响**
 */
