 ...
 * 同时会生成一个宏任务setTimeout4
 *    2.然后去查看宏任务队列，宏任务setTimeout2在setTimout4之前，先执行setTimeout2，输出setTimeout2。
 *    3.在执行宏任务setTimeout2时会生成微任务Promise3，放入微任务队列中，接着先去清空微任务队列中的所有任务。
 * 输出Promise3
 *    4.清空完微任务中的所有任务后，就会去宏任务队列取一个，这回执行的时setTimeout4;
 */
